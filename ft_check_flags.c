...
/*   Updated: 2022/10/27 18:45:44 by yrhiba           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_fcheck_zero(const char *format, int *i, t_print *tab)
{
	if (format[*i] == '0')
	{
		tab->zero = 1;
...
static void	ft_fcheck_mins(const char *format, int *i, t_print *tab)
{
	if (format[*i] == '-')
	{
		tab->mines = 1;
...
static void	ft_fcheck_point(const char *format, int *i, t_print *tab)
{
	if (format[*i] == '.')
	{
		tab->point = 1;
